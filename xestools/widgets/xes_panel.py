...
class XESPanel(QGroupBox):
    def __init__(self, parent=None):
        ...
        self.btn_remove_selected = QPushButton("Remove Highlighted")
        ...
        # Row 2: average + saves
        row2 = QHBoxLayout()
        self.btn_average = QPushButton("Average Ticked")
        ...
        row2.addWidget(self.btn_save_norm)
        ...
        self.lbl_norm = QLabel("Average: No Normalisation Applied")
        ...
        rowb2 = QHBoxLayout()
        self.btn_save_fit_log = QPushButton("Save LMFit Log")
        self.btn_save_bkg_data = QPushButton("Save bkg subtracted data")
